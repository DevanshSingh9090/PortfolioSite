...
const Portfolio = () => {
  ...
  const fullText = "Hi, I'm Devansh Singh";
  ...
  const projects = [
    ...
    },
    {
      ...
      liveDemo: "#",
      github: "https://github.com/DevanshSingh9090/RazorPayFrontendCloneTailwind",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex space-x-6">
              <a
                href="https://github.com/DevanshSingh9090"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/devansh-singh-a12472287/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/devanshsingh_1010/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto achievement-cards">
              ...
              <motion.div
                ...
                onClick={() =>
                  window.open("https://leetcode.com/u/devansh_singh_9090/", "_blank")
                }
              >
              ...
              <motion.div
                ...
                onClick={() =>
                  window.open(
                    "https://www.codechef.com/users/devansh_9090",
                    "_blank"
                  )
                }
              >
              ...
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center hover:scale-102 transition-all duration-200 group cursor-pointer achievement-card"
                onClick={() =>
                  window.open("https://github.com/DevanshSingh9090", "_blank")
                }
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 contact-grid">
            <div className="space-y-8">
              ...
              <div className="flex space-x-6">
                ...
                <a
                  href="mailto:devanshsingh9090@gmail.com"
